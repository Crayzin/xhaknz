...
return message.channel.send(new Discord.MessageEmbed().setDescription(' <a:verified4:930118279895334963> '+`${args[0]}`+' adet mesaj başarıyla silindi.')).then(m => m.delete({timeout: 5000}));
};
exports.conf = {
  enabled: true,
  guildOnly: true,
