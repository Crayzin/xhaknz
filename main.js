const Discord = require("discord.js");//yDarKDayS v12 Boş Altyapı
...
client.giveawaysManager = new GiveawaysManager(client, {
    ...
    default: {
        botsCanWin: false,
        embedColor: "#f3152",
        reaction: "<a:Gieway:929826422204293190>"
    }
});
...
//client.on('message', async msg => {
 // if(msg.content == `<@921149728626987049>`) return msg.channel.send(`> **değistir | **\n\n> ::   **Sanırım beni etiketlediniz.**\n > :gifpin:  Buyurun prefixim \`${prefix}\``);
//}); 
...
client.on('message', async msg => {
  if(msg.content == `<@921149728626987049>`) return msg.channel.send(`> <a:siyah_tac:930082414217293894> **Sanırım Benim Hakkımda Bilgi Almaya Çalıștın.**\n > <a:SabitGif:930082747236646952> **Buyrun Prefixim:** . \n > <a:SabitGif:930082747236646952> **Yardım Komutlarımı Görmek İçin** .yardım **Yaz** `);
});
...
//const GiveawayManagerWithOwnDatabase = class extends  giewaysManager {
...
client.ekoayarlar = {
  parabirimi: "PL", //Para Birimi TL İsterseniz Dolar Euro Vb. Para Birimleri Girebilirsiniz.
  botunuzunprefixi: ".",
  botunuzunidsi: "921149728626987049",
  botismi: "Plover Bot",
...
client.on("message", async (msg, member, guild) => {
  ...
  if (i === "açık") {
    if (msg.content.toLowerCase() === "sa") {
      msg.reply(
        "**Aleyküm Selam Hoşgeldin, İyi Eğlenceler <a:selamm:930116872207204362> **"
      );
    }
  }
});
...
client.on("message", async (msg, member, guild) => {
  ...
  if (i === "açık") {
    if (msg.content.toLowerCase() === "s.a") {
      msg.reply("**Aleyküm Selam Dostum Hoşgeldin, İyi Eğlenceler ^^**");
    }
  }
});
client.on("message", async (msg, member, guild) => {
...
////yDarKDayS v12 Boş Altyapı https://www.youtube.com/c/yDarKDayS